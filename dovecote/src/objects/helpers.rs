...
pub fn sign_device_token(pigeon_id: &str, env: &Env) -> worker::Result<(String, OffsetDateTime)> {
  ...
  // let expires_at = now + 31_536_000; // 365 days
  ...
  let claims = Claims::create(Duration::from_secs(31_536_000)).with_subject(pigeon_id);
